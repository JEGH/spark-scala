object LearningScala1 {
  ...
  val new_pi = 2 * pi                             //> new_pi  : Double = 6.2831853
  //println(f:"New PI $new_pi%.3f")
  println(f"New Pi $new_pi%.3f")                  //> New Pi 6.283
  
  val val_name : String = "John Snow"             //> val_name  : String = John Snow
  var var_name : String = "John Snow"             //> var_name  : String = John Snow
}